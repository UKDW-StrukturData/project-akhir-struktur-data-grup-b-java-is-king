...
# #             st.write("**Games played:** 15")
# #             st.write("**Achievements:** 47")
# #             st.write("**Play time:** 128 hours")
        
# #         st.subheader("Recent Activity")
# #         activities = [
# #             {"game": "Adventure Quest", "time": "2 hours ago", "action": "Completed Level 5"},
# #             {"game": "Space Warriors", "time": "5 hours ago", "action": "New High Score: 15,240"},
# #             {"game": "Brain Teaser", "time": "1 day ago", "action": "Solved 20 puzzles"}
# #         ]
        
# #         for activity in activities:
# #             st.write(f"🎮 **{activity['game']}** - {activity['action']}")
...
# # # Sidebar dengan tombol back (jika user belum login)
# # if not st.session_state.get('logged_in', False):
# #     with st.sidebar:
# #         st.write("### Navigation")
# #         if st.button("🔙 Back to Login", key="sidebar_back"):
# #             st.switch_page("main.py")
...
# # st.markdown("---")
# # st.caption("© 2024 PlayHub - All rights reserved")
...
# # ... (kode home.py sebelumnya tetap)
# tab1, tab2, tab3, tab4 = st.tabs(["🎯 Our Games", "🔥 Steam Charts", "📊 Analytics", "👤 Profile"])
# # Di bagian Profile tab, tambahkan:
# with tab1:
#     st.header("👤 Your Profile")
